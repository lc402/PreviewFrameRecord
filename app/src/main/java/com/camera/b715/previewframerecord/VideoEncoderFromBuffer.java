...
public class VideoEncoderFromBuffer {
	private static final String TAG = "liuchang_VideoBuffer";
	...
	@SuppressLint("NewApi")
	public VideoEncoderFromBuffer(String fileName_debug, int width, int height) {
		...
		String fileName = fileName_debug + DEBUG_FILE_NAME_BASE + this.mWidth + "x"
				+ this.mHeight + ".mp4";
	...
	public void encodeFrame(byte[] input/* , byte[] output */) {
		...
		do {
			if (outputBufferIndex == MediaCodec.INFO_TRY_AGAIN_LATER) {
				...
				Log.d("liuchang","mBufferInfo.size != 0");
...
//					}
					Log.d("liuchang","mMuxer.writeSampleData");
